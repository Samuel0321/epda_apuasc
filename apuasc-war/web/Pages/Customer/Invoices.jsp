    ...
    <div class="main">
        ...
        <div class="summary-cards">
            ...
            <div class="summary-card">
                ...
                <div class="summary-value">RM 2,250</div>
            </div>
            <div class="summary-card">
                <div class="summary-label">Amount Pending</div>
                <div class="summary-value warning">RM 200</div>
            </div>
        </div>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <div class="action-buttons">
                                ...
                                <button class="btn-small btn-download">⬇</button>
                            </div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-buttons">
                                <button class="btn-small btn-view">View</button>
                                <button class="btn-small btn-pay">Pay Now</button>
                            </div>
                        </td>
                    </tr>
                    <tr>
